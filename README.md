...
```bash
./script/build.sh
./profiling/script/run.sh RECORD 8
```

To report,
for instance report perf data from the processus 5

```bash
./profiling/script/run.sh REPORT 5
#or
./profiling/script/run.sh HOTSPOT 5 #for a gui representation
